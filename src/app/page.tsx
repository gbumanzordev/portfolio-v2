        ...
        <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Link href="mailto:contact@gbumanzor.dev">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full bg-zinc-800/50 hover:bg-zinc-800 text-zinc-400 hover:text-white"
              ...
              <GlassmorphicCard>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="font-medium">contact@gbumanzor.dev</div>
                  </div>
                  <div className="space-y-1">
      ...
      <section id="skills" className="py-32 relative">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-16">
            ...
            <SkillBadge name="Angular" level={95} />
            <SkillBadge name="HTML/CSS" level={95} />
            <SkillBadge name="Tailwind CSS" level={90} />
            <SkillBadge name="Vue.js" level={75} />
        ...
        <div className="container flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            <Link href="/" className="font-bold text-xl">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">Gerson</span>
