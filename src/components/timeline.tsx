        ...
        >
              ...
              <div className='relative'>
                ...
                <ul>
                  {experience.descriptionItems.map((item, index) => (
                    <li key={index} className='text-zinc-300 list-disc ml-4'>
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          {!isMobile && (
            <div className='absolute left-1/2 -translate-x-1/2 flex items-center justify-center'>
              <motion.div
                className='w-6 h-6 rounded-full bg-gradient-to-r from-gray-600 to-gray-500 z-10 flex items-center justify-center'
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
